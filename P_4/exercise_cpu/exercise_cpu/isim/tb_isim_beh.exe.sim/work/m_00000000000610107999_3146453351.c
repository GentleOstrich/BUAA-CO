...
#endif
static const char *ng0 = "D:/University/Study/2022fall/co/P_4/exercise_cpu/exercise_cpu/npc.v";
...
LAB20:    t423 = (t0 + 7144);
    ...
    t433 = *((char **)t432);
    memcpy(t433, t3, 8);
    xsi_driver_vfirst_trans(t423, 0, 31);
    t434 = (t0 + 6744);
    *((int *)t434) = 1;
...
LAB121:    if (*((unsigned int *)t288) > 0)
        goto LAB122;

LAB123:    memcpy(t287, t323, 8);

LAB124:    goto LAB102;

LAB103:    xsi_vlog_unsigned_bit_combine(t181, 32, t282, 32, t287, 32);
    goto LAB107;

LAB105:    memcpy(t181, t282, 8);
    goto LAB107;
...
LAB116:    t317 = (t0 + 3944U);
    t318 = *((char **)t317);
    goto LAB117;

LAB118:    t317 = (t0 + 1864U);
    t325 = *((char **)t317);
    t317 = ((char*)((ng9)));
    memset(t326, 0, 8);
    t327 = (t325 + 4);
...
LAB134:    memcpy(t380, t342, 8);

LAB135:    memset(t324, 0, 8);
    t412 = (t380 + 4);
...
LAB150:    t419 = (t324 + 4);
    t420 = *((unsigned int *)t324);
    t421 = *((unsigned int *)t419);
    t422 = (t420 || t421);
    if (t422 > 0)
        goto LAB151;

LAB152:    t425 = *((unsigned int *)t324);
    t426 = (~(t425));
...
LAB156:    if (*((unsigned int *)t324) > 0)
        goto LAB157;

LAB158:    memcpy(t323, t429, 8);

LAB159:    goto LAB119;

LAB120:    xsi_vlog_unsigned_bit_combine(t287, 32, t318, 32, t323, 32);
    goto LAB124;

LAB122:    memcpy(t287, t318, 8);
    goto LAB124;
...
LAB141:    if (*((unsigned int *)t373) != 0)
        goto LAB142;

LAB143:    t381 = *((unsigned int *)t342);
...
LAB151:    t423 = (t0 + 3784U);
    t424 = *((char **)t423);
    goto LAB152;

LAB153:    t423 = (t0 + 3624U);
    t429 = *((char **)t423);
    goto LAB154;

LAB155:    xsi_vlog_unsigned_bit_combine(t323, 32, t424, 32, t429, 32);
    goto LAB159;

LAB157:    memcpy(t323, t424, 8);
    goto LAB159;

}


extern void work_m_00000000000610107999_3146453351_init()
{
	static char *pe[] = {(void *)Cont_27_0,(void *)Cont_28_1,(void *)Cont_29_2,(void *)Cont_33_3,(void *)Cont_34_4,(void *)Cont_35_5};
	xsi_register_didat("work_m_00000000000610107999_3146453351", "isim/tb_isim_beh.exe.sim/work/m_00000000000610107999_3146453351.didat");
