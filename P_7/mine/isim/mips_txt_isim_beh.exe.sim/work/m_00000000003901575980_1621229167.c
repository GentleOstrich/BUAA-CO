...
#endif
static const char *ng0 = "D:/University/Study/2022fall/co/P_7/temp/GRF.v";
static int ng1[] = {1, 0};
static int ng2[] = {0, 0};
static int ng3[] = {32, 0};
...
LAB60:    memcpy(t60, t22, 8);

LAB61:    memset(t92, 0, 8);
    t74 = (t60 + 4);
...
LAB95:    xsi_set_current_line(26, ng0);
    t2 = (t0 + 2888);
    t3 = (t2 + 56U);
    t4 = *((char **)t3);
    t5 = (t0 + 2888);
...
LAB85:    if (*((unsigned int *)t108) != 0)
        goto LAB86;

LAB87:    t131 = *((unsigned int *)t92);
    t132 = *((unsigned int *)t122);
    t133 = (t131 & t132);
    *((unsigned int *)t130) = t133;
    t123 = (t92 + 4);
...
LAB91:    xsi_set_current_line(23, ng0);

LAB94:    xsi_set_current_line(24, ng0);
    t145 = (t0 + 2008U);
    t162 = *((char **)t145);
    t145 = (t0 + 2728);
...
LAB49:    xsi_set_current_line(41, ng0);
    ...
    t40 = (t0 + 1848U);
    t77 = *((char **)t40);
    xsi_vlog_generic_convert_array_indices(t30, t31, t35, t38, 2, 1, t77, 5, 2);
    t40 = (t30 + 4);
    t9 = *((unsigned int *)t40);
    t39 = (!(t9));
    t78 = (t31 + 4);
...
extern void work_m_00000000003901575980_1621229167_init()
{
	static char *pe[] = {(void *)Always_17_0,(void *)Always_32_1};
	xsi_register_didat("work_m_00000000003901575980_1621229167", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000003901575980_1621229167.didat");
